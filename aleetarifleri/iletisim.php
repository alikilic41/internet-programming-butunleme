...
<html lang="en">
    <head>
        ...
        <title>Alee'nin Tarifleri | İletişim</title>
    ...
    <body>
        ...
        <main class="mb-4">
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <p>Lütfen formu doğru bir şekilde doldurunuz, Sizinle en yakın zamanda iletişime geçeceğiz.</p>
                        <div class="my-5">
                            <!-- * * * * * * * * * * * * * * *-->
                            ...
                            <form action="iletisim.php#bildiri" method="POST" id="contactForm" data-sb-form-api-token="API_TOKEN">
                                <div class="form-floating">
                                    <input class="form-control" name="name" type="text" placeholder="Ad Soyad" data-sb-valnameations="required" />
                                ...
                                <div class="form-floating">
                                    ...
                                    <div class="invalid-feedback" data-sb-feedback="email:email">E-mail geçerli değil.</div>
                                </div>
                                <div class="form-floating">
                                    <input class="form-control" name="phone" type="tel" placeholder="Telefon" data-sb-validations="required" />
                                    <label for="phone">Telefon</label>
                                    <div class="invalid-feedback" data-sb-feedback="phone:required">Telefonunuzu giriniz.</div>
                                </div>
                                <div class="form-floating">
                                    <textarea class="form-control" name="message" placeholder="Mesaj" style="height: 12rem" data-sb-validations="required"></textarea>
                                    <label for="message">Mesaj</label>
                                    <div class="invalid-feedback" data-sb-feedback="message:required">İletmek istediğiniz mesajı giriniz.</div>
                                </div>
                                <br />
