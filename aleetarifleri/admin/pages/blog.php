                                ...
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <?php if($row["aktif"] ==1) { ?>
                                                <a href="blog.php?is=aktif&id=<?= $row["id"] ?>&drm=<?= $row["aktif"] ?>" onclick="return confirm
                                                ('Aktiflik durumu değişsin mi?')" 
                                            ...
                                            <a href="blog.php?is=sil&id=<?= $row["id"] ?>" onclick="return confirm('Silmek istediğinize emin misiniz?')" 
